...
- Implementation：`/Users/miyin/code for people/ideal/docs/kith-inn/yao/prototype-customer/index.html?step=menu`；修改后截图 `/tmp/kith-menu-mask-after.png`，`1265 × 998 px`。

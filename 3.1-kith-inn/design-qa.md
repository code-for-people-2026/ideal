...
- 迁移前角色原型：
  - `/Users/miyin/code for people/cfp-mono/docs/3.1-kith-inn/prototype-taozi/index.html`
  - `/Users/miyin/code for people/cfp-mono/docs/3.1-kith-inn/prototype-customer/index.html`
- 产品内容真相：
...
- 换菜交互参考：用户指定的 `/cfp-mono/docs/3.1-kith-inn/prototype/menu-brain.html`；本地解析到 `/Users/miyin/code for people/cfp-mono-worktrees/community-cooking-mock-ui/docs/3.1-kith-inn/prototype/menu-brain.html`。
...
- Source visual truth：修改前页面截图 `/tmp/kith-menu-audit-2026-08-11/01-menu-current.png`；Implementation：`3.1-kith-inn/prototype-customer/index.html?step=menu`，修改后截图 `/tmp/kith-menu-refine-2026-08-11/11-after-final.png`。
...
- Implementation：`3.1-kith-inn/prototype-customer/index.html?step=menu` 与 `?step=reconcile`；浏览器全屏证据 `/tmp/kith-menu-filter-2026-08-11/menu-all.jpg`、`/tmp/kith-menu-filter-2026-08-11/menu-veg-filter.jpg`、`/tmp/kith-menu-filter-2026-08-11/reconcile-inline-detail.jpg`，均为 `1265 × 712 px`。
...
- Implementation：`3.1-kith-inn/prototype-customer/index.html?step=menu`；默认状态证据 `/tmp/kith-menu-filter-2026-08-11/menu-default-meat-label-left-final.jpg`，Codex Desktop `1280 × 720 CSS px`、手机框约 `390 × 748 CSS px`、`deviceScaleFactor = 1`。

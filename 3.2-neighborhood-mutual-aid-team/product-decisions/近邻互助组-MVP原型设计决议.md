...
所有消息必须清楚标明是真人、服务者 Agent 还是近邻系统 Agent。Agent 不得伪装成真人。
...
主界面不是单独与一个聊天机器人对话，而是以服务需求为上下文的四方聊天室。
...
页面顶部应能一眼看见四方身份及当前会话可见范围。

### 7.2 首次进入房间的消息顺序

1. 系统提示本房间从哪里进入，以及带入了哪些需求摘要。
2. 近邻系统 Agent 说明自己负责权限、需求整理和寻找其他服务者，不代表桃子。
3. 桃子的 Agent 主动向顾客打招呼，说明可以回答的内容和真人确认边界。

### 7.3 沟通规则

- 顾客可以继续和桃子的 Agent 聊。
- 顾客可以选择“找桃子本人聊”，让桃子加入同一房间。
- 输入区清楚显示当前消息发给 Agent 还是真人。
- 服务者 Agent 可以回答已确认的菜单、时间、流程等信息。
- 接单、报价、临时调整和最终承诺必须由服务者本人确认。
- 真人加入后只能看到当前会话的需求摘要和房间消息，不能看到顾客的其他对话。
...
6. 顾客选择候选人后，建立新的四方混合会话。

新的服务者房间重复同一规则：系统 Agent 管权限与亲历来源，服务者 Agent 负责初步接待，服务者本人负责最终承诺，顾客可以选择和谁说话。
...
- 近邻系统 Agent 可以解释权限、整理需求和提供匹配，但不替任何一方承诺。
- 共同履约事实与私人记忆必须分开处理。
...
- [产品背景](../../3.3-niuma-mutual-aid-platform/product-decisions/平台MVP-咨询转介闭环草案.md)
- [相邻方案](../../3.3-niuma-mutual-aid-platform/product-decisions/地理服务场MVP-产品草案.md)
- [领域词汇](../CONTEXT.md)

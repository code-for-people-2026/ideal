...
- `prototype-implementation/`：可运行工程原型，完整联动周切换、生成、换菜、手选、保存、菜品库、历史和“我的”，并保留页面地图与实现说明。
...
- `prototype-implementation/`：React + Vite 可运行工程原型；`page-map.html` 和 `engineering-model.html` 分别保留页面地图与实现说明。
